...
//===----------------------------------------------------------------------===//
//
// Phase-2 "good citizen" instrumentation probes shared by the Muxer and Security conformance harnesses.
// These inspect whether a module's handlers behave well inside NIO: that a write future is tied to the
// actual socket write (not completed prematurely), and that channelRead / channelReadComplete are fired.
